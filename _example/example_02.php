    ...
    */
    ...
    if( isset( $_POST['form_send'] ) && $_POST['form_send'] == 'mhm' ) {
        ...
        try {
            ...
            # files array
            $files_array = array( $_FILES['first_file'], $_FILES['second_file'], $_FILES['third_file'] );
            for( $i = 0; $i < count( $files_array ); $i++ ) {
            
                try {
    
                    # insert file to class
                    $php_upload -> set_new_file( $files_array[$i] );
                    
                    # upload file
                    $php_upload -> save_file();
                    
                    # clear file data
                    $php_upload -> clear_file_data();
...
<body>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="field_border"><input type="file" name="second_file" /></div>
        <div class="field_border"><input type="file" name="third_file" /></div>
